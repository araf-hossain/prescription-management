    ...
    <header>
      <ul class="sidenav" id="side-menu">
        <li>
          <div class="user-view">
            ...
            @endphp
            <a href="#name"><span id="username">Hello, {{ $name }}</span></a><br>
            <a href="#email"><span id="email">{{Auth::user()->email ?? ''}}</span></a>
          </div>
        </li>
        <li class="divider"></li>
        <li><a href="{{ route('patients.index') }}">Consult A Doctor</a></li>
        <li><a href="{{ route('patients.prescriptions') }}">My Prescriptions</a></li>
        <li class="divider"></li>
        <li><a href="{{ route('patients.profile', Auth::user()->id) }}">View Profile</a></li>
      ...
      <div class="navbar">
        ...
        <nav class="blue darken-2">
          <div class="container nav-wrapper">
            <a href="{{ route('patients.index') }}" class="brand-logo">Online Prescription</a>
            ...
            <ul class="right hide-on-med-and-down">
              ...
              @else
              <li><a href="{{ route('patients.index') }}">Sign In</a></li>
              @endif
            </ul>
          </div>
        </nav>
      ...
      <div class="modal" id="logoutmodal">
        ...
        <div class="modal-footer">
          ...
          <a href="{{ route('patients.logout') }}" class="btn modal-close waves-effect waves-light">Logout</a>
        </div>
      </div>
    </header>
    <main>
