...
@section('title', "Patient's Login")
@section('sidenavoptions')
<li class="active"><a class="waves-effect" href="{{ route('patients.login') }}">Sign In</a></li>
<li class=""><a class="waves-effect" href="{{ route('patients.register') }}">Sign Up</a></li>
@endsection
@section('topnavoptions')
<li class="active"><a href="{{ route('patients.login') }}">Sign In</a></li>
<li class=""><a href="{{ route('patients.register') }}">Sign Up</a></li>
@endsection
@section('content')
...
<div class="container">
  ...
  <div class="row" id="login-container">
    ...
    <div class="card" id="login-form">
      ...
      <form class="row card-content" action="{{ route('patients.login.submit') }}" method="post">
        @csrf
        ...
        <div class="col s12" id="other-action">
          ...
          <p>Don't have an account? <a href="{{ route('patients.register') }}" class="underlined">Sign Up Instead</a></p>
        </div>
      </form>
    </div>
  </div>
